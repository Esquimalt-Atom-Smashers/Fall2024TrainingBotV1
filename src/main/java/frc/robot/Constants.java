...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        // public static final int anglePeakCurrentLimit = 40;// doesn't work with falcons in v6
        //public static final double anglePeakCurrentDuration = 0.0; hardcoded into falconSwerveConfigs since it doesn't work
        public static final boolean angleEnableCurrentLimit = true;

        public static final int driveContinuousCurrentLimit = 5;
        // public static final int drivePeakCurrentLimit = 60; // doesn't work with falcons in v6
        //public static final double drivePeakCurrentDuration = 0.0; hardcoded into falconSwerveConfigs since it doesn't work
