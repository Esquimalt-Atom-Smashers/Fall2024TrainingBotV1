...
public class TeleopSwerve extends Command {    
    ...
    public void execute() {
        ...
        /* Drive */
        s_Swerve.drive(
            new Translation2d(translationVal, strafeVal).times(Constants.Teleop.kMaxSpeedMetersPerSecond), 
            rotationVal * Constants.Teleop.kMaxAngularSpeedRadiansPerSecond, 
